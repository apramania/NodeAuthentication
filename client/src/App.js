            ...
            <div className='w-full flex-1 mt-8 text-indigo-500'>
              ...
              <div className='mx-auto max-w-xs relative '>
                ...
                <Link
                  ...
                  className='mt-5 tracking-wide font-semibold bg-red-500 text-gray-100 w-full py-4 rounded-lg hover:bg-gray-700 transition-all duration-300 ease-in-out flex items-center justify-center focus:shadow-outline focus:outline-none'
                >
                  Reset password
                </Link>
              </div>
